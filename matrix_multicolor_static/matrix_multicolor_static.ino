...
void loop() {
  matrix.drawPixel(0,0, matrix.Color(255, 0, 150));
  matrix.show();
  delay(100);
}
...
void loop() {
  matrix.drawPixel(0,2, matrix.Color(255, 120, 0));
  matrix.show();
  delay(100);
}

void loop() {
  matrix.drawPixel(0,3, matrix.Color(255, 200, 0));
  matrix.show();
  delay(100);
}

void loop() {
  matrix.drawPixel(0,4, matrix.Color(0, 255, 0));
  matrix.show();
  delay(100);
}
