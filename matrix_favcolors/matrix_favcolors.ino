...
void loop() {
  ...
  matrix.drawPixel(1,0, matrix.Color(0, 255, 255));
  matrix.drawPixel(2,0, matrix.Color(0, 255, 0));
  matrix.drawPixel(3,0, matrix.Color(0, 255, 255));
  ...
  matrix.drawPixel(7,0, matrix.Color(0, 255, 255));
  matrix.show();
  delay(100);
}
